...
type InlineImportBarProps = {
  sessionId: string;
  onImportComplete: () => void;
};

export function InlineImportBar({ sessionId, onImportComplete }: InlineImportBarProps) {
  ...
  return (
    <div className="mb-6 rounded-lg border bg-card p-4">
      <div className="mb-2 flex items-center gap-2">
        ...
        <span className="text-sm font-medium">Import & Map Content</span>
      </div>
